...
- [📊 Software Compatibility](#software-compatibility)
  ...
  - [IoTextra — Node-RED Compatibility Table](#iotextra--node-red-compatibility-table)
  - [IoTextra — Tasmota Compatibility Table](#iotextra--tasmota-compatibility-table)
...
### <a name="iotextra--node-red-compatibility-table"></a>IoTextra — Node-RED Compatibility Table
...
### <a name="iotextra--tasmota-compatibility-table"></a>IoTextra — Tasmota Compatibility Table
